...
export const getLoadingPaymentRedirect = createSelector((state: IStore) => state.loading.loadingPaymentRedirect, (loadingPaymentRedirect) => loadingPaymentRedirect);

export const getLoadingKlaviyoSuscribers = createSelector((state: IStore) => state.loading.loadingKlaviyoSuscribers, (loadingKlaviyoSuscribers) => loadingKlaviyoSuscribers);