          ...
          >
            <DropdownHeader>
              <TextSelected>
                ...
                >
                  {!isCategory && "-"}{" "}
                  {heightCm[selectedProp as keyof typeof heightCm]} de altura
                </Text>
              </TextSelected>
            </DropdownHeader>

            <Arrow $isOpen={isHeightyOpen}>{ArrowQuantity()}</Arrow>
                      ...
                      return (
                        <ListItem
                          ...
                          $isDisable={
                            !(
                              childrenByHeight[
                                height as keyof typeof childrenByHeight
                              ]["stock"] > 0 ||
                              childrenByHeight[
                                height as keyof typeof childrenByHeight
                              ]["backorder"]
                        ...
                        >
                          <TextSelected>
                            ...
                            >
                              {heightCm[height as keyof typeof heightCm]} de
                              altura
                            </Text>
                          </TextSelected>
                        </ListItem>
