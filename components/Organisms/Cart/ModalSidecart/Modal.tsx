            ...
            <div ref={modalRefChildren} className={`modal-container ${isOpen ? 'open' : ''}`}>
                ...
                <div  className="header-cart">
                    <div className="header-cart-closer">
                        ...
                        <button title="Cerrar modal" aria-label="Cerrar modal" className="header-closer-2" onClick={closeModal}>
                            <img 
                            src="https://imagedelivery.net/7yveHullsFjmXtPLdJPFsg/527083b1-56bb-4a75-1a98-e7cffd083800/fit=cover" 
                            alt="cerrar carrito img" 
                            loading="lazy"
                            /* fetchPriority="low" */
                            />
                        </button>
