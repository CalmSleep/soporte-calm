...
export const TypographyStyled = styled.div<TypographyStyledProps>`
  ...
  ${(props) =>
    props.$textStroke && `-webkit-text-stroke: ${props.$textStroke};`}
  ${({ $letterSpacing }) =>
  ...
  @media ${(props) => props.theme.devices.mobile} {
    width: ${({ $responsiveMobile }) =>
      $responsiveMobile?.width ? `${$responsiveMobile.width}` : "auto"};
    font-size: ${({ $responsiveMobile }) =>
      $responsiveMobile?.fontSize && `${$responsiveMobile.fontSize}`};
    text-align: ${({ $responsiveMobile }) =>
      $responsiveMobile && `${$responsiveMobile.align}`};
    color: ${({ $responsiveMobile, theme }) =>
      $responsiveMobile?.color && theme.colors[`${$responsiveMobile.color}`]};
    ${({ $responsiveMobile }) =>
      $responsiveMobile &&
      $responsiveMobile.lineHeight &&
      `line-height: ${$responsiveMobile.lineHeight}`};
  }
